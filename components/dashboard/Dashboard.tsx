...
import { exportarHistoricoCSV, importarHistoricoCSV } from "@/lib/exportacao";
...
export function Dashboard() {
  ...
  const iconeBotaoClasse =
    "grid h-10 w-10 place-items-center rounded-lg border border-slate-300 bg-white text-slate-500 transition hover:bg-slate-50 hover:text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white";
            ...
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={iconeBotaoClasse}
                >
                  <Icon nome="enviar" tamanho={16} />
                </button>
                <button
                  onClick={() => exportarHistoricoCSV(dados)}
                  title="Baixar histórico (CSV)"
                  aria-label="Baixar histórico"
                  className={iconeBotaoClasse}
                >
                  <Icon nome="baixar" tamanho={16} />
                </button>
              </div>
            </div>
